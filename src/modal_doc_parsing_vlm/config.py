...
EXTRACTION_WARMUP_REQUESTS = int(os.environ.get("DOC_PARSE_EXTRACTION_WARMUP_REQUESTS", "4"))
EXTRACTION_MAX_RUNNING_REQUESTS = int(
    os.environ.get("DOC_PARSE_EXTRACTION_MAX_RUNNING_REQUESTS", "8")
)
EXTRACTION_MEM_FRACTION = float(os.environ.get("DOC_PARSE_EXTRACTION_MEM_FRACTION", "0.9"))
